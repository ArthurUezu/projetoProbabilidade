...
def main():
    ...
    if len(sys.argv)==2:
        ...
        dado_Efarsas = definir_periodo(dado_FatoFake,converter_data(sys.argv[1]),converter_data(sys.argv[2]))
        dado_Efarsas = definir_periodo(dado_Efarsas,converter_data(sys.argv[1]),converter_data(sys.argv[2]))
